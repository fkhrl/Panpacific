...
<!-- Mirrored from www.Panpacificinn.com/eclub.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 01 Mar 2017 05:28:18 GMT -->
<head>
	<meta charset="utf-8">
    	...
    	<div class="row rs">
        	...
        	<div class="col-lg-6 col-md-6 col-sm-6 page-heading no-padding-left">
        		<div class="page-heading">
	        		<h1>Join our eClub and stay up to date.</h1>
                    <div style="max-width:350px; margin-top:25px">
                    <p>Fill out the form  to receive emails containing our latest deals and exclusive offers. After submitting the form you will receive a confirmation email. Please click the link in the email to complete the subscription process.</p>
                    <p>You can unsubscribe anytime. By filling out the above form you agree to receive further email communications from Panpacific Inn and Conference Centre.
If you have any questions, contact <a href="mailto:reservations@Panpacificinn.com">reservations@Panpacificinn.com</a> or call +13065008169.</p>
</div>
	            </div>
      		</div>
            <div class="col-lg-6 col-md-6 col-sm-6 sub-page-heading" style="padding-left:0;padding-right:0;line-height: 24px; font-size: 15px;">
              <iframe style="width:450px; height:500px; overflow:hidden !important; border:none" src="http://eclub.atlific.com/Panpacific-inn-conference-centre-website-signup/"></iframe>
            </div>
        </div>
