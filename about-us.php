...
<!-- Mirrored from www.Panpacificinn.com/about-us.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 01 Mar 2017 05:55:11 GMT -->
<head>
	<meta charset="utf-8">
   	<meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="The premier full service hotel and conference centre in Panpacific, near downtown and the airport">
    <meta name="keywords" content="">
    <meta name="author" content="Panpacific Inn Hotel & Conference Centre">
    <title>About the Panpacific Inn, Stay In Style! | Panpacific Inn Hotel & Conference Centre</title>
...
<body onLoad="initialize();">
    ...
    <div class="carousel-inner">
      <div class="item active">
        <div class="fill bg-about">
        </div>
        <div class="container">
        	            <div class="carousel-caption carousel-caption-about">
              <div class="heading-border"></div>	
              <h2>About the Panpacific Inn</h2>
              <div class="heading-border"></div>	
            </div>
                     </div>
      </div>
	...
	<div class="container">
    	<div class="row">
        	...
        	<div class="col-lg-12 col-md-12 col-sm-12 page-heading no-padding-left">
            	<div class="heading-call">About Panpacific Inn & Conference Centre</div>
                
                <div class="page-heading text-center">
                    <h2>
                        Panpacific Inn & Conference Centre Grand Opening Launch was on Valentine's Day, 1982. That date marked the beginning of our strong relationship with our many patrons who have experienced the tradition in hospitality at the Panpacific Inn & Conference Centre.
                    </h2>
                </div>
             </div>
             <br clear="all" /><br />
