...
<!-- Mirrored from www.Panpacificinn.com/media.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 01 Mar 2017 05:55:14 GMT -->
<head>
	<meta charset="utf-8">
    ...
    <title>media | Panpacific Inn Hotel & Conference Centre</title>
...
<body onLoad="initialize();">
    ...
    <div class="carousel-inner">
      <div class="item active">
        <div class="fill bg-amenities">
        </div>
        <div class="container">
        	            <div class="carousel-caption carousel-caption-Media">
    	...
    	<div class="row">
        	<div class="col-lg-6 col-md-6 col-sm-6 page-heading no-padding-left">
        		<div class="page-heading">
	        		<h2>
	                	For media information please contact:</h2>
Roanne Goldsman or Mindy Cummings</br>
Aerial Communications Group</br>
416-787-6577</br>
<a href="mailto:roanne@aerialpr.com">roanne@aerialpr.com</a></br>
<a href="mindy%40aerialpr.php">mindy@aerialpr.com</a>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 sub-page-heading" style="padding-left:0;padding-right:0;line-height: 24px; font-size: 15px;">
               <h4>IMAGE LIBRARY</h4>
<p>For press ready &amp; high resolution images, access our digital image library on&nbsp;<a href="https://clientservices.vfmii.com/pdl/Main.php?company=atlific" target="_blank"><img class="size-full wp-image-456" src="../www.copperpointresort.com/wp-content/uploads/2015/12/leonardo-logo.png" alt="leonardo" width="132" height="36"></a></p>
<p>Please note digital images may be used solely for editorial or promotions that are specific to Panpacific Inn and Conference Center. Photo credit must be given to Panpacific Inn and Conference Center.</p>
        </div>
...
<!-- Mirrored from www.Panpacificinn.com/media.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 01 Mar 2017 05:55:16 GMT -->
</html>    