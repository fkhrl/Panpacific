...
<!--[if lt IE 9]><link rel="stylesheet" href="' . $this->baseUrl("../assets/components/library/bootstrap/css/bootstrap.min.css") . '" />
    <![endif]-->
...
';
    ...
    function baseUrl($suffix = '') {
        ...
        $web_root = $protocol . $_SERVER['HTTP_HOST'] . "/" . "a.m.softltd/panpacificin/cms-admin/";
        $suffix = ltrim($suffix, '/');
    ...
    public function softwareTitle($title = '') {
        if ($title != '') {
            ...
            $content = '<title>Admin CMS (Content Management System) By amsoftltd</title>';
            return $content;
        }
    }
